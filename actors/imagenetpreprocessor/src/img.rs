...
pub fn preprocess(raw_data: &[u8], height: u32, width: u32) -> RpcResult<Vec<u8>> {
    ...
    // Resize array to width, height, depth=1, 3 channels
    let mut array =
        ndarray::Array::from_shape_fn((1, 3, height as usize, width as usize), |(_, c, j, i)| {
